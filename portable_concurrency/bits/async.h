 ...
 * always created instead of `future<future<R>>` and `shared_future<R>` instead of `future<shared_future<R>>` by
 * applying rules specified in "The C++ Extensions for Concurrency" TS as implicit unwrapping.
 *
