...
auto invoke(T B::* pmf, D&& ref, A&&... args)
  noexcept(noexcept((std::forward<D>(ref).*pmf)(std::forward<A>(args)...)))
  -> std::enable_if_t<
...
auto invoke(T B::* pmf, RefWrap&& ref, A&&... args)
  noexcept(noexcept((ref.get().*pmf)(std::forward<A>(args)...)))
  -> std::enable_if_t<
    std::is_function<T>::value &&
...
auto invoke(T B::* pmf, P&& ptr, A&&... args)
  noexcept(noexcept(((*std::forward<P>(ptr)).*pmf)(std::forward<A>(args)...)))
  -> std::enable_if_t<
    std::is_function<T>::value &&
...
auto invoke(T B::* pmd, D&& ref)
  noexcept(noexcept(std::forward<D>(ref).*pmd))
  -> std::enable_if_t<
    !std::is_function<T>::value &&
    std::is_base_of<B, std::decay_t<D>>::value,
...
auto invoke(T B::*pmd, RefWrap&& ref)
...
auto invoke(T B::* pmd, P&& ptr)
  noexcept(noexcept((*std::forward<P>(ptr)).*pmd))
  -> std::enable_if_t<
    !std::is_function<T>::value &&
    !is_reference_wrapper<std::decay_t<P>>::value &&
    !std::is_base_of<B, std::decay_t<P>>::value,
...
auto invoke(F&& f, A&&... args)
  noexcept(noexcept(std::forward<F>(f)(std::forward<A>(args)...)))
  -> std::enable_if_t<
